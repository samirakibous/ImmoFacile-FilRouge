...
@section('content')
    <div class="relative w-full h-screen">
        ...
        <div class="relative flex flex-col items-center justify-center h-full text-white text-center">
            ...
            <p class="mt-4 text-lg w-3/4 text-[#F7E9CC] ">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam, quam?</p>
            
            <!-- Barre de recherche -->
            <div class="mt-6">
                <input type="text" placeholder="Search" class="px-4 py-2 rounded-full bg-[#F7E9CC] bg-opacity-80 text-gray-900 w-80">
            </div>
        </div>
    </div>
@endsection
