    ...
    <div class=" container mx-auto px-4 py-8">
        ...
        <div class="relative w-full h-64 bg-gray-800">
            ...
            <div class="absolute inset-0 bg-cover bg-center"
                style="background-image: url('{{ asset('storage/' . (Auth::user()->profile_picture ?? 'image.png')) }}')">
        ...
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex space-x-2">
                    ...
                    <button
                        class="px-4 py-2 border border-orange-500 rounded-md flex items-center text-orange-500 bg-white hover:bg-orange-50">
